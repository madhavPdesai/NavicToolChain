...
// there are 4 satellites active.. since we are using
// a big mem per sat.
#define ACTIVE_NUMBER_OF_SATELLITES 	 	4	
...
// acquire.
//
#define ACQUISITION_THRESHOLD 			25000000.0
...
// DLL interval (ie interval in ms between updates to code-phase).
//     Lock stability is not so good if this number is increased.
#define DLL_INTERVAL			1

//
// code error filters..  use a low pass IIR
//  but the optimal parameters are not finalized as of now.
//  
#define EL_EPSILON 	0.0
#define EL_FILTER_K0	(D_C1 + D_C2)
#define EL_FILTER_K1 	(- D_C1)
